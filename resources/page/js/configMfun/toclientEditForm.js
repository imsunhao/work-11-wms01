...
var ToclientEditForm = function() {
	...
	var ReceiptEditFormVali = function() {
		var editReceiptForm = $("#editReceiptForm");
		// 字符验证 
		editReceiptForm.validate({
			errorElement : 'span',
			...
			submitHandler : function(form) {
				...
				$.ajax({
					url : getRootPath() + "/receipt/editReceipt",
					type : 'post',
					data : {
