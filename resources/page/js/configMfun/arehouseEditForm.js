...
var ArehouseEditForm = function() {
	...
	var ArehouseEditFormVali = function() {
		var arehouseEditForm = $("#editArehouseForm");
		// 字符验证 
		arehouseEditForm.validate({
			errorElement : 'span',
			...
			submitHandler : function(form) {
				...
				$.ajax({
					url : getRootPath() + "/arehouse/editArehouseForm",
					type : 'post',
					data : {
						"arehouseId" : $("input[name='arehouse_Id']").val(),
