...
var GoodsAddForm = function() {
	...
	var GoodsAddFormVali = function() {
		var addGoodsForm = $("#addGoodsForm");
		// 字符验证 
		addGoodsForm.validate({
			...
			messages : {
				no : {
					...
					required : "<i class=\"fa fa-bolt \"></i> 请填写货品编号！"
				},
				nameJc : {
					minlength : "<i class=\"fa fa-bolt \"></i> 输入字符需要多于2个字符！",
				...
				name : {
					minlength : "<i class=\"fa fa-bolt \"></i> 输入字符需要多于2个字符！",
					maxlength : "<i class=\"fa fa-bolt \"></i> 输入字符需要小于20个字符！",
					required : "<i class=\"fa fa-bolt \"></i> 请填写货品名称！"
				}
			},
			...
			submitHandler : function(form) {
				...
				$.ajax({
					url : getRootPath() + "/goods/addGood",
					type : 'post',
					data : {
						"no" : $("input[name='no']").val(),
						"nameJc" : $("input[name='nameJc']").val(),
