		...
		<div class="col-xs-12 col-md-12">
			<div class="widget">
				...
				<div class="widget-body bordered-top bordered-bottom bordered-blueberry ">
					...
					<button class="btn btn-darkorange timeChange_" id="reservation">
						<i class="fa  fa-table"></i> 全部数据
					</button>
					<hr class="wide">
					...
					<div class="paramInfo">
						<span class="status_"></span> <span class="arehouseid_"></span>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="aboutRkrbcxFun" tabindex="-1" role="dialog" aria-hidden="true">
...
<script src="page/js/main/rkrbcx.js" type="text/javascript"></script>
