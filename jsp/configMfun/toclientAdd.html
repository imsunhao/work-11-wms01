...
<div class="widget">
	<div class="widget-header bordered-bottom bordered-palegreen">
		<span class="widget-caption">新增发货方</span>
	</div>
	<div class="widget-body">
		<div>
			<form class="form-horizontal form-bordered" role="form" id="addReceiptForm">

				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">收货方名称</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="receiptName" placeholder="收货方名称">
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">收货方地址</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="receiptAddr" placeholder="收货方地址">
					</div>
				</div>
...
<script src="page/js/configMfun/toclientAddForm.js" type="text/javascript"></script>
<script type="text/javascript">
	jQuery(document).ready(function() {
		ToclientAddForm.init();
	});
</script>
