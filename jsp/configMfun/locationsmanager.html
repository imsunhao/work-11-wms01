		...
		<div class="col-xs-12 col-md-12">
			<div class="widget">
				<div class="widget-header bordered-bottom bordered-yellow">
					<span class="widget-caption">储位组配置管理</span>
...
<div class="modal fade" id="aboutLocationsModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script src="page/js/configMfun/locationsmanager.js" type="text/javascript"></script>
