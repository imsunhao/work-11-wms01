...
<div class="modal fade" id="aboutGoodsModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script src="page/js/configMfun/goodsmanager.js" type="text/javascript"></script>
