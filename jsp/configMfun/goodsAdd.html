...
<div class="widget">
	<div class="widget-header bordered-bottom bordered-palegreen">
		<span class="widget-caption">新增货品配置</span>
	</div>
	<div class="widget-body">
		<div>
			<form class="form-horizontal form-bordered" role="form" id="goodsAddForm">

				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">货品编号</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="goodsNo" placeholder="货品编号">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="goodsName" placeholder="货品名称">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">货品名简称</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="name_jc" placeholder="货品名简称">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="tit" placeholder="设置T值">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">配置I值</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="tii" placeholder="设置I值">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">配置换算量</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="hsl" placeholder="设置换算量">
					</div>
				</div>
...
<script src="page/js/configMfun/goodsAdd.js" type="text/javascript"></script>
