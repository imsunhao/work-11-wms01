...
<div class="modal fade" id="aboutGroupModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script src="page/js/configMfun/groupmanager.js" type="text/javascript"></script>
