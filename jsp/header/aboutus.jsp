...
<div class="page-breadcrumbs">
	<ul class="breadcrumb">
		<li><i class="fa fa fa fa-meh-o"></i> <a href="#">关于我们</a></li>
		...
		<div class="col-lg-12 col-sm-12 col-xs-12">
			<div class="well invoice-container">
				<div class="row">
					<div class="col-xs-6">
						<h3 class="">
							<i class="fa fa-bookmark-o"></i> 仓库管理系统
						</h3>

					</div>
					<div class="col-xs-6 text-right">
						<h1>
							<a href="#"> <img src="page/img/logo.png" alt="" style="width: 200px; height: 45px; margin-right: -17px">
							</a>
						</h1>
						<div>
							<span>Invoice:</span> <span>#121212</span> <span> | </span> <span>Date:</span> <span>04/04/2014</span> <span> | </span> <a href="#"> <i class="glyphicon glyphicon-print carbon"></i>
							</a>
						</div>
