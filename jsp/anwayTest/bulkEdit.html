...
<div class="widget">
	<div class="widget-header bordered-bottom bordered-palegreen">
		<span class="widget-caption">编辑整箱单位</span>
	</div>
	<div class="widget-body">
		<div>
			<form class="form-horizontal form-bordered" role="form" id="editContainerForm">

				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">整箱单位名称</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="name" placeholder="整箱单位名称" value="${container.name }">
					</div>
				</div>
...
<input type="text" class="form-control" name="container_Id" value="${container.containerId }" style="display: none"/>
...
<script src="page/js/configMfun/containerEditForm.js" type="text/javascript"></script>
<script type="text/javascript">
	jQuery(document).ready(function() {
		ContainerEditForm.init();
	});
</script>
