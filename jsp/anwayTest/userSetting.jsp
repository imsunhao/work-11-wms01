...
<div id="registration-form">
	<form role="form">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
				    ...
				    <div class="boxFooter">
				        <input type="text" id="startX" name="x1" value="0">
				        <input type="text" id="startY" name="y1" value="0">
				        <input type="text" id="width" name="x2" value="198">
				        <input type="text" id="height" name="y2" value="198"> 
			...
			<div class="form-group">
				<div id="preview" style="width: 100px; height: 100px; overflow: hidden;">
					<img id="view_photo" src="page/img/attach-blue.png" style="width: 100px;height: 100px; ">
				</div><br/><br/>
			</div>
		...
		<div class="col-sm-12">
			<div class="form-group">
				<label for="inputName">Name</label> <span class="input-icon icon-right"> <input type="text" class="form-control" id="inputName" name="inputName" placeholder="Name"> <i class="glyphicon glyphicon-user palegreen"></i>
				</span>
			</div>
		</div>
		...
		<div class="col-sm-12">
			<div class="form-group">
				<label for="inputMessage">Message</label> <span class="input-icon icon-right"> <textarea class="form-control" id="inputMessage" name="inputMessage" rows="10"></textarea> <i class="glyphicon glyphicon-briefcase darkorange"></i>
				</span>
...
<input type="text" class="form-control" name="group_Id" value="${activeUser.userid }" />
